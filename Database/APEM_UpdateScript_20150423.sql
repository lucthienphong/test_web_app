GO
IF COL_LENGTH('tblJob','ItemCode') IS  NULL
BEGIN
	ALTER table tblJob
...
GO
/****** Object:  StoredProcedure [dbo].[TblInvoice_SelectAll]    Script Date: 04/23/2015 12:42:48 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[Report_SalesReport]    Script Date: 23/04/2015 23:16:03 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
begin
	...
	select ROW_NUMBER() OVER(ORDER BY j.JobNumber) as RowIndex, j.JobNumber, c.SAPCode, r.Code, j.JobName, j.Design, 
		...
		from tblJob j INNER JOIN
			...
			tblCustomer bo ON j.BrandOwner = bo.CustomerID LEFT OUTER JOIN
