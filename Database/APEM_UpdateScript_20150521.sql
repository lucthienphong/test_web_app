...
/****** Object:  StoredProcedure [dbo].[Report_SalesReport]    Script Date: 05/21/2015 15:32:46 ******/
SET ANSI_NULLS ON
GO
...
begin
	...
	select ROW_NUMBER() OVER(ORDER BY j.JobNumber) as RowIndex, j.JobNumber, c.SAPCode, r.Code, j.JobName, j.Design, 
			...
			ROUND((oc.TotalPrice * (1 - oc.Discount/100)) * (1 + oc.TaxPercentage/100), 1) as TotalValue
