<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" AutoEventWireup="true" CodeBehind="CreditList.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.CreditList" %>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3">
                    <div class="form-group">
                        ...
                        <div>
                            <asp:TextBox ID="txtCreditNo" runat="server" class="form-control"></asp:TextBox>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-3">
        ...
        <div class="col-md-12">
            <div class="dataTables_wrapper form-inline">
                <SweetSoft:GridviewExtension ID="grvCrebitList" runat="server" AutoGenerateColumns="false"
                    ...
                    AllowPaging="true" AllowSorting="true" DataKeyNames="CreditID"
                    OnRowCommand="grvCrebitList_RowCommand"
                    OnPageIndexChanging="grvCrebitList_PageIndexChanging"
                    OnSorting="grvCrebitList_Sorting">
                    <Columns>
                        <asp:TemplateField HeaderText="CreditNumber" SortExpression="0" HeaderStyle-CssClass="sorting"
                            ItemStyle-CssClass="column-one">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEdit" runat="server"
                                    CommandArgument='<%#Eval("CreditID")%>' CommandName="Detail"
                                    Text='<%#Eval("CreditNo")%>' data-id='<%#Eval("CreditID")%>'></asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-CssClass="column-one" HeaderText="CreditDate"
                            SortExpression="1" HeaderStyle-CssClass="sorting">
                            <ItemTemplate>
                                <asp:Label ID="lbCreditDate" runat="server"
                                    Text='<%#Eval("CreditDate")%>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu openPrinting" role="menu" style="right: 0; left: auto">
                                        <li><a href="javascript:;" data-href='Printing/PrintCreditDetail.aspx?ID=<%#Eval("CreditID") %>'>Credit Note</a></li>
                                    </ul>
                                </div>
                            </ItemTemplate>
                        </asp:TemplateField>
