...
TableTools.BUTTONS = {
	...
	"delete": $.extend({}, TableTools.buttonBase, {
	    ...
	    "sMessage": null,
	    "bShowAll": true,
	    "sToolTip": "Delete item selected",
	    "sButtonClass": "DTTT_button_delete",
	    "sButtonText": "Delete",
	    "fnClick":null
	}),
	"save": $.extend({}, TableTools.buttonBase, {
	    "sInfo": "<h6>Save data</h6><p>Please use your browser's print function to " +
		  "print this table. Press escape when finished.",
	    "sMessage": null,
	    "bShowAll": true,
	    "sToolTip": "Save data",
	    "sButtonClass": "DTTT_button_save",
	    "sButtonText": "Save",
	    "fnClick": null
	}),
