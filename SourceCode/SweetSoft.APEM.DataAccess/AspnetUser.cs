...
namespace SweetSoft.APEM.DataAccess
{
	...
	public partial class AspnetUser : ActiveRecord<AspnetUser>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Users", TableType.Table, DataService.GetInstance("DataAcessProvider"));
				...
				DataService.Providers["DataAcessProvider"].AddSchema("aspnet_Users",schema);
			}
		}
		#endregion
		...
		public SweetSoft.APEM.DataAccess.AspnetMembershipCollection AspnetMembershipRecords()
		{
			...
			{
				colAspnetMembershipRecords = new SweetSoft.APEM.DataAccess.AspnetMembershipCollection().Where(AspnetMembership.Columns.UserId, UserId).Load();
		...
		public SweetSoft.APEM.DataAccess.AspnetPersonalizationPerUserCollection AspnetPersonalizationPerUserRecords()
		{
			...
			{
				colAspnetPersonalizationPerUserRecords = new SweetSoft.APEM.DataAccess.AspnetPersonalizationPerUserCollection().Where(AspnetPersonalizationPerUser.Columns.UserId, UserId).Load();
		...
		private SweetSoft.APEM.DataAccess.AspnetProfileCollection colAspnetProfileRecords;
		public SweetSoft.APEM.DataAccess.AspnetProfileCollection AspnetProfileRecords()
		{
			if(colAspnetProfileRecords == null)
			{
				colAspnetProfileRecords = new SweetSoft.APEM.DataAccess.AspnetProfileCollection().Where(AspnetProfile.Columns.UserId, UserId).Load();
		...
		public SweetSoft.APEM.DataAccess.AspnetUsersInRoleCollection AspnetUsersInRoles()
		{
			...
			{
				colAspnetUsersInRoles = new SweetSoft.APEM.DataAccess.AspnetUsersInRoleCollection().Where(AspnetUsersInRole.Columns.UserId, UserId).Load();
		...
		public SweetSoft.APEM.DataAccess.AspnetRoleCollection GetAspnetRoleCollection() { return AspnetUser.GetAspnetRoleCollection(this.UserId); }
		public static SweetSoft.APEM.DataAccess.AspnetRoleCollection GetAspnetRoleCollection(Guid varUserId)
		{
        ...
        public void SetPKValues()
        {
                ...
                if (colAspnetProfileRecords != null)
                {
                    foreach (SweetSoft.APEM.DataAccess.AspnetProfile item in colAspnetProfileRecords)
                    {
                        if (item.UserId != UserId)
                        {
                            item.UserId = UserId;
