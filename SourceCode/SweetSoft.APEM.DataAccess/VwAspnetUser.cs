...
namespace SweetSoft.APEM.DataAccess{
    ...
    public partial class VwAspnetUser : ReadOnlyRecord<VwAspnetUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Users", TableType.View, DataService.GetInstance("DataAcessProvider"));
                ...
                DataService.Providers["DataAcessProvider"].AddSchema("vw_aspnet_Users",schema);
            }
        }
        #endregion
