...
namespace SweetSoft.APEM.DataAccess
{
	...
	public partial class TblOtherCharge : ActiveRecord<TblOtherCharge>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarJobID.DefaultSetting = @"";
					...
					colvarJobID.ForeignKeyTableName = "tblOrderConfirmation";
		...
		/// <summary>
		/// Returns a TblOrderConfirmation ActiveRecord object related to this TblOtherCharge
		/// 
		/// </summary>
		public SweetSoft.APEM.DataAccess.TblOrderConfirmation TblOrderConfirmation
		{
			get { return SweetSoft.APEM.DataAccess.TblOrderConfirmation.FetchByID(this.JobID); }
