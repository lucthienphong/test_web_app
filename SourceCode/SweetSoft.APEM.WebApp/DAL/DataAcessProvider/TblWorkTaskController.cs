...
namespace SweetSoft.APEM.DataAccess
{
    ...
    public partial class TblWorkTaskController
    {
	    ...
	    public void Insert(string Name,short? DepartmentID,double? Constant1,double? Constant2,double? Constant3,double? Constant4,byte? IsPlating,byte? CurrentState,byte? ShowInWorkFlow,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn)
	    {
	    ...
	    public void Update(int Id,string Name,short? DepartmentID,double? Constant1,double? Constant2,double? Constant3,double? Constant4,byte? IsPlating,byte? CurrentState,byte? ShowInWorkFlow,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn)
	    {
		    TblWorkTask item = new TblWorkTask();
	        item.MarkOld();
	        item.IsLoaded = true;
