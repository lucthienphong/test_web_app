	...
	public partial class TblCurrencyChangedLog : ActiveRecord<TblCurrencyChangedLog>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarNewValue.DataType = DbType.Decimal;
				...
				colvarNewRMValue.DataType = DbType.Decimal;
				colvarNewRMValue.MaxLength = 0;
		...
		{
			get { return GetColumnValue<decimal?>(Columns.NewValue); }
		...
		[Bindable(true)]
		public decimal? NewRMValue 
		{
			get { return GetColumnValue<decimal?>(Columns.NewRMValue); }
		...
		/// </summary>
		public static void Insert(DateTime? varDateChanged,string varNewName,decimal? varNewValue,string varModifiedBy,int? varCurrencyID,string varStatus,decimal? varNewRMValue)
		{
		...
		/// </summary>
		public static void Update(long varId,DateTime? varDateChanged,string varNewName,decimal? varNewValue,string varModifiedBy,int? varCurrencyID,string varStatus,decimal? varNewRMValue)
		{
			TblCurrencyChangedLog item = new TblCurrencyChangedLog();
