...
namespace SweetSoft.APEM.DataAccess
{
	...
	public partial class AspnetApplication : ActiveRecord<AspnetApplication>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_Applications", TableType.Table, DataService.GetInstance("DataAcessProvider"));
				...
				DataService.Providers["DataAcessProvider"].AddSchema("aspnet_Applications",schema);
			}
		}
		#endregion
		...
		private SweetSoft.APEM.DataAccess.AspnetMembershipCollection colAspnetMembershipRecords;
		public SweetSoft.APEM.DataAccess.AspnetMembershipCollection AspnetMembershipRecords()
		{
			if(colAspnetMembershipRecords == null)
			{
				colAspnetMembershipRecords = new SweetSoft.APEM.DataAccess.AspnetMembershipCollection().Where(AspnetMembership.Columns.ApplicationId, ApplicationId).Load();
		...
		private SweetSoft.APEM.DataAccess.AspnetPathCollection colAspnetPaths;
		public SweetSoft.APEM.DataAccess.AspnetPathCollection AspnetPaths()
		{
			if(colAspnetPaths == null)
			{
				colAspnetPaths = new SweetSoft.APEM.DataAccess.AspnetPathCollection().Where(AspnetPath.Columns.ApplicationId, ApplicationId).Load();
		...
		private SweetSoft.APEM.DataAccess.AspnetRoleCollection colAspnetRoles;
		public SweetSoft.APEM.DataAccess.AspnetRoleCollection AspnetRoles()
		{
			if(colAspnetRoles == null)
			{
				colAspnetRoles = new SweetSoft.APEM.DataAccess.AspnetRoleCollection().Where(AspnetRole.Columns.ApplicationId, ApplicationId).Load();
		...
		private SweetSoft.APEM.DataAccess.AspnetUserCollection colAspnetUsers;
		public SweetSoft.APEM.DataAccess.AspnetUserCollection AspnetUsers()
		{
			if(colAspnetUsers == null)
			{
				colAspnetUsers = new SweetSoft.APEM.DataAccess.AspnetUserCollection().Where(AspnetUser.Columns.ApplicationId, ApplicationId).Load();
        ...
        public void SetPKValues()
        {
                if (colAspnetMembershipRecords != null)
                {
                    foreach (SweetSoft.APEM.DataAccess.AspnetMembership item in colAspnetMembershipRecords)
                    {
                ...
                if (colAspnetPaths != null)
                {
                    foreach (SweetSoft.APEM.DataAccess.AspnetPath item in colAspnetPaths)
                    {
                        if (item.ApplicationId != ApplicationId)
                        {
                            item.ApplicationId = ApplicationId;
                ...
                if (colAspnetRoles != null)
                {
                    foreach (SweetSoft.APEM.DataAccess.AspnetRole item in colAspnetRoles)
                    {
                        if (item.ApplicationId != ApplicationId)
                        {
                            item.ApplicationId = ApplicationId;
                ...
                if (colAspnetUsers != null)
                {
                    foreach (SweetSoft.APEM.DataAccess.AspnetUser item in colAspnetUsers)
                    {
                        if (item.ApplicationId != ApplicationId)
                        {
                            item.ApplicationId = ApplicationId;
