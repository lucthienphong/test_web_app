...
namespace SweetSoft.APEM.DataAccess
{
    ...
    public partial class TblNotificationSettingController
    {
	    ...
	    public void Insert(string Title,string Description,string PageId,string Actions,string TriggerButton,bool? IsObsolete,string CommandType,string DismissEvent,string ReceiveIds,string ReceiveType,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn)
	    {
	    ...
	    public void Update(int SettingId,string Title,string Description,string PageId,string Actions,string TriggerButton,bool? IsObsolete,string CommandType,string DismissEvent,string ReceiveIds,string ReceiveType,string CreatedBy,DateTime? CreatedOn,string ModifiedBy,DateTime? ModifiedOn)
	    {
		    TblNotificationSetting item = new TblNotificationSetting();
	        item.MarkOld();
	        item.IsLoaded = true;
