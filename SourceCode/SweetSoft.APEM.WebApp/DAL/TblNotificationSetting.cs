	...
	public partial class TblNotificationSetting : ActiveRecord<TblNotificationSetting>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarModifiedBy.MaxLength = 255;
		...
		/// </summary>
		public static void Insert(string varTitle,string varDescription,string varPageId,string varActions,string varTriggerButton,bool? varIsObsolete,string varCommandType,string varDismissEvent,string varReceiveIds,string varReceiveType,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
		...
		/// </summary>
		public static void Update(int varSettingId,string varTitle,string varDescription,string varPageId,string varActions,string varTriggerButton,bool? varIsObsolete,string varCommandType,string varDismissEvent,string varReceiveIds,string varReceiveType,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
			TblNotificationSetting item = new TblNotificationSetting();
