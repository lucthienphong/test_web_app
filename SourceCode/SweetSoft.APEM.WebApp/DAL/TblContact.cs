...
namespace SweetSoft.APEM.DataAccess
{
	...
	public partial class TblContact : ActiveRecord<TblContact>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varContactName,string varHonorific,string varDesignation,string varTel,string varEmail,int varCustomerID)
		{
		...
		/// </summary>
		public static void Update(int varContactID,string varContactName,string varHonorific,string varDesignation,string varTel,string varEmail,int varCustomerID)
		{
			TblContact item = new TblContact();
