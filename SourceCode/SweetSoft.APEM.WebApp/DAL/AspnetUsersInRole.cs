...
namespace SweetSoft.APEM.DataAccess
{
	...
	public partial class AspnetUsersInRole : ActiveRecord<AspnetUsersInRole>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("aspnet_UsersInRoles", TableType.Table, DataService.GetInstance("DataAcessProvider"));
				...
				DataService.Providers["DataAcessProvider"].AddSchema("aspnet_UsersInRoles",schema);
			}
		}
		#endregion
		...
		/// 
		/// </summary>
		public SweetSoft.APEM.DataAccess.AspnetRole AspnetRole
		{
			get { return SweetSoft.APEM.DataAccess.AspnetRole.FetchByID(this.RoleId); }
