...
{
	/// <summary>
	/// Strongly-typed collection for the TblCustomerQuotationOtherCharge class.
	/// </summary>
    [Serializable]
	public partial class TblCustomerQuotationOtherChargeCollection : ActiveList<TblCustomerQuotationOtherCharge, TblCustomerQuotationOtherChargeCollection>
	{	   
		public TblCustomerQuotationOtherChargeCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>TblCustomerQuotationOtherChargeCollection</returns>
		public TblCustomerQuotationOtherChargeCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TblCustomerQuotationOtherCharge o = this[i];
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the tblCustomerQuotation_OtherCharges table.
	/// </summary>
	[Serializable]
	public partial class TblCustomerQuotationOtherCharge : ActiveRecord<TblCustomerQuotationOtherCharge>, IActiveRecord
	{
		#region .ctors and Default Settings
		
		public TblCustomerQuotationOtherCharge()
		{
		  SetSQLProps();
		  InitSetDefaults();
		  MarkNew();
		...
		public TblCustomerQuotationOtherCharge(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public TblCustomerQuotationOtherCharge(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public TblCustomerQuotationOtherCharge(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("tblCustomerQuotation_OtherCharges", TableType.Table, DataService.GetInstance("DataAcessProvider"));
				...
				DataService.Providers["DataAcessProvider"].AddSchema("tblCustomerQuotation_OtherCharges",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(string varGLCode,string varDescription,decimal varPrice,short varCurrencyID,int varCustomerID)
		{
		...
		/// </summary>
		public static void Update(int varId,string varGLCode,string varDescription,decimal varPrice,short varCurrencyID,int varCustomerID)
		{
			TblCustomerQuotationOtherCharge item = new TblCustomerQuotationOtherCharge();
