...
namespace SweetSoft.APEM.DataAccess
{
	...
	public partial class TblCylinderProcessing : ActiveRecord<TblCylinderProcessing>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int? varCylinderID,string varDescription,string varCreatedBy,DateTime? varCreatedOn,string varFinishedBy,DateTime? varFinishedOn,short? varDepartmentID,string varCylinderStatus,int? varMachineID)
		{
		...
		/// </summary>
		public static void Update(int varId,int? varCylinderID,string varDescription,string varCreatedBy,DateTime? varCreatedOn,string varFinishedBy,DateTime? varFinishedOn,short? varDepartmentID,string varCylinderStatus,int? varMachineID)
		{
			TblCylinderProcessing item = new TblCylinderProcessing();
