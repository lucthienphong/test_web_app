...
namespace SweetSoft.APEM.DataAccess
{
	...
	public partial class TblPricing : ActiveRecord<TblPricing>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarForTobaccoCustomers.IsReadOnly = false;
						...
						colvarForTobaccoCustomers.DefaultSetting = @"((0))";
		...
		/// </summary>
		public static void Insert(string varPricingName,bool varForTobaccoCustomers,bool varIsObsolete)
		{
		...
		/// </summary>
		public static void Update(short varPricingID,string varPricingName,bool varForTobaccoCustomers,bool varIsObsolete)
		{
			TblPricing item = new TblPricing();
