...
namespace SweetSoft.APEM.DataAccess
{
    ...
    public partial class TblUserController
    {
	    ...
	    public void Insert(int UserID,string UserName,string Password,string Email,string DisplayName,bool IsObsolete)
	    {
	    ...
	    public void Update(int UserID,string UserName,string Password,string Email,string DisplayName,bool IsObsolete)
	    {
		    TblUser item = new TblUser();
	        item.MarkOld();
	        item.IsLoaded = true;
