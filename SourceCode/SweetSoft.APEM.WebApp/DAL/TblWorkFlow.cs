	...
	public partial class TblWorkFlow : ActiveRecord<TblWorkFlow>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarMachineryProduceTypeID.IsForeignKey = false;
				colvarMachineryProduceTypeID.IsReadOnly = false;
				colvarMachineryProduceTypeID.DefaultSetting = @"";
				colvarMachineryProduceTypeID.ForeignKeyTableName = "";
				...
				colvarIdParent.IsNullable = true;
		...
		/// </summary>
		public static void Insert(int? varFID,string varCode,bool? varIsFirstPage,bool? varIsShow,string varContentXML,int? varAxisTypeID,int varMachineryProduceTypeID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,int? varIdParent)
		{
		...
		/// </summary>
		public static void Update(int varId,int? varFID,string varCode,bool? varIsFirstPage,bool? varIsShow,string varContentXML,int? varAxisTypeID,int varMachineryProduceTypeID,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn,int? varIdParent)
		{
			TblWorkFlow item = new TblWorkFlow();
