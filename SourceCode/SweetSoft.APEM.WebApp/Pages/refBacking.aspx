<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" AutoEventWireup="true" CodeBehind="refBacking.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.refBacking" %>
        ...
        <div class="col-md-12">
            ...
            <div class="dataTables_wrapper form-inline sweet-input-mask">
                <SweetSoft:GridviewExtension ID="gvBacking" runat="server" AutoGenerateColumns="false"
                    ...
                    AllowPaging="true" AllowSorting="true" DataKeyNames="BackingID"
                        ...
                        <asp:TemplateField HeaderText="Backing Name" SortExpression="0" HeaderStyle-CssClass="sorting">
                            ...
                            <EditItemTemplate>
                                ...
                                <div class="form-group" style="width: 100%">
                                    <SweetSoft:CustomExtraTextbox RenderOnlyInput="true" ID="txtBackingName"
                                        Text='<%#Eval("BackingName")%>' Width="100%"
                                        CssClass="form-control" runat="server">
                                    </SweetSoft:CustomExtraTextbox>
                                </div>
                            </EditItemTemplate>
