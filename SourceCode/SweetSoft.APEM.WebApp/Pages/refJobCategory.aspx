<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" AutoEventWireup="true" CodeBehind="refJobCategory.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.refJobCategory" %>
            ...
            <div class="dataTables_wrapper form-inline sweet-input-mask">
                <div class="dataTables_wrapper form-inline sweet-input-mask">
                    <SweetSoft:GridviewExtension ID="gvReference" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Job Category Code" SortExpression="0" HeaderStyle-CssClass="sorting">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Job Category" SortExpression="1" HeaderStyle-CssClass="sorting">
                                <ItemTemplate>
