<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" AutoEventWireup="true" CodeBehind="Debit.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.Debit" %>
        ...
        <div class="button-control col-md-12 col-sm-12">
            <div class="form-inline">
                <div class="form-group" style="margin-bottom: 0; width: 100%;">
                    ...
                    <a href="DebitList.aspx" class="btn btn-transparent new">
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="form-group">
                                ...
                                <p class="form-control-static">
                                    <asp:Label ID="lblDebitNumber" runat="server"></asp:Label>
                                </p>
                            </div>
                        </div>
                                    ...
                                    <asp:TemplateField ItemStyle-CssClass="column-one" HeaderStyle-CssClass="checkbox-column">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-primary"
                                                CommandArgument='<%# Eval("DebitDetailID") %>' CommandName="Edit">
...
<asp:Content ID="Content4" ContentPlaceHolderID="ScriptPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
                ...
                $("input[type='text'][id$='txtName']").autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            ...
                            url: "Debit.aspx/GetCustomerData",
        ...
        Sys.WebForms.PageRequestManager.getInstance().add_endRequest(PrintDedit);
        function PrintDedit() {
