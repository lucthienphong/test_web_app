<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" AutoEventWireup="true" CodeBehind="refSupply.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.refSupply" %>
    ...
    <div class="row row_content">
        <div class="col-md-12">
            ...
            <div class="dataTables_wrapper form-inline sweet-input-mask">
                <SweetSoft:GridviewExtension ID="gvSupply" runat="server" AutoGenerateColumns="false"
                    CssClass="table table-striped table-bordered table-checkable dataTable" GridLines="None"
                    AllowPaging="true" AllowSorting="true" DataKeyNames="SupplyID"
                    OnPageIndexChanging="gvSupply_PageIndexChanging"
                    OnSorting="gvSupply_Sorting"
                    OnRowDeleting="gvSupply_RowDeleting"
                    OnRowEditing="gvSupply_RowEditing"
                    OnRowUpdating="gvSupply_RowUpdating"
                    OnRowCreated="gvSupply_RowCreated"
                    OnRowCancelingEdit="gvSupply_RowCancelingEdit">
                    <Columns>
                        <asp:TemplateField HeaderText="Supply Name" SortExpression="0" HeaderStyle-CssClass="sorting">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnEdit" runat="server"
                                    Text='<%#Eval("SupplyName")%>'
                                    CommandName="Edit"></asp:LinkButton>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <div class="form-group" style="width: 100%">
                                    <SweetSoft:CustomExtraTextbox RenderOnlyInput="true" ID="txtSupplyName"
