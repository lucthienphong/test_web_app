<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master"
    AutoEventWireup="true" CodeBehind="CustomerGroup.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.CustomerGroup" %>
                    ...
                    <div class="form-horizontal">
                        ...
                        <asp:LinkButton ID="btnCancel" Visible="false" Enabled="false" runat="server"
                            class="btn btn-transparent new" OnClick="btnCancel_Click">
                                <span class="flaticon-back57"></span> Back to list</asp:LinkButton>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="dataTables_wrapper form-inline sweet-input-mask">
                <div class="dataTables_wrapper form-inline sweet-input-mask">
                    <SweetSoft:GridviewExtension ID="gvReference" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Country code" SortExpression="0" HeaderStyle-CssClass="sorting">
                                <ItemTemplate>
                                ...
                                <EditItemTemplate>
                                    <div class="form-group" style="width: 100%">
                                        <SweetSoft:CustomExtraTextbox RenderOnlyInput="true" ID="txtCountryCode"
                             ...
                             <asp:TemplateField HeaderText="Country name" SortExpression="1" HeaderStyle-CssClass="sorting">
                                <ItemTemplate>
                                    <asp:Label runat="server" ID="lblCountryName" Text='<%#Eval("Name") %>'></asp:Label>
                                </ItemTemplate>
                                <EditItemTemplate>
                                    <div class="form-group" style="width: 100%">
                                        <SweetSoft:CustomExtraTextbox RenderOnlyInput="true" ID="txtCountryName"
