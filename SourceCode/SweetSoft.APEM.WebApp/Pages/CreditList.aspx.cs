...
{
    public partial class CreditList : ModalBasePage
    {
        ...
        public override void BindData()
        {
            ...
            {
                int totalRows = 0;
                string CreditNo = txtCreditNo.Text.Trim();
                ...
                DataTable dt = CreditManager.SelectAll(CreditNo, Customer, FromDate, ToDate, grvCrebitList.PageIndex, grvCrebitList.PageSize, SortColumn, SortType);
        ...
        protected void grvCrebitList_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "Detail")
            {
                ...
                Response.Redirect("~/Pages/Credit.aspx?ID=" + ID.ToString());
            }
        }
        ...
        private void removeSelectedRows(List<int> idList)
        {
            foreach (int ID in idList)
            {
                ...
                if (obj != null)
                {
                    CreditManager.Delete(obj.CreditID);
