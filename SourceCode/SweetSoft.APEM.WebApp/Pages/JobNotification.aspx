<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" 
    ...
    Inherits="SweetSoft.APEM.WebApp.Pages.JobNotification"
     CodeBehind="JobNotification.aspx.cs" %>

<%@ Register Assembly="CKEditor.NET" Namespace="CKEditor.NET" TagPrefix="CKEditor" %>
<%@ Register Src="~/Controls/JobNotificationSetting.ascx" TagPrefix="SweetSoft" TagName="JobNotificationSetting" %>
        ...
        <div class="row">
            <div class="tab-content">
                <div class="tab-pane active" id="insert">
                    <SweetSoft:JobNotificationSetting runat="server" CommandType="insert" id="NotificationSettingInsert" />
                </div>
                <div class="tab-pane " id="update">
                    <SweetSoft:JobNotificationSetting runat="server" CommandType="update" id="NotificationSettingUpdate" />
                </div>
                <div class="tab-pane " id="delete">
                    <SweetSoft:JobNotificationSetting runat="server" CommandType="delete" id="NotificationSettingDelete" />
                </div>
            </div>
        </div>
    </div>
