        ...
        function initialize(instance) {
			...
			*/
            ...
            if (options.url != null && $.trim(options.url) != "") {
                ...
                // show loading image
                container.append("<div class='frame_loading'></div>");
                var loading = container.children(".frame_loading");
                //loading.css("marginLeft", '-' + (loading.outerWidth() / 2) + 'px');
		...
		*/
            ...
            _adjustMinimizedPos(false, function () {
                ...
                header.click(function () {
                    if (!animating) {
                        ...
                        if (options.hideOther === true) {
                            var url = $.Window.getSelectedWindow() && $.Window.getSelectedWindow().getUrl();
                            //console.log(url);
                            var all = $.window.getAll();
                            if (typeof all !== 'undefined' && all.length > 0) {
                                $.each(all, function (i, o) {
                                    var s = o.getUrl();
                                    if (s && (s.toLowerCase() !== url.toLowerCase())) {
        ...
        function close(quiet) {
            ...
            if (!quiet && $.isFunction(options.onClose)) {
                canClose = options.onClose(_this);
            }
            if (canClose !== false)
                destroy();
        }
