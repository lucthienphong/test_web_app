<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintCreditDetail.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.Printing.PrintCreditNote" %>
        ...
        <form id="form1" runat="server">
            <div class="container-fluid" id="wrapPrint">
                <div class="printContent">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h3 style="font-weight: 700; margin-top: 0">Credit Memo
                            </h3>
                        </div>
                        <div class="col-xs-4">
                            <strong>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <asp:Repeater ID="rptCreditDetail" runat="server" OnItemCreated="RepeaterItemCreated">
                                <ItemTemplate>
                                    <div style="display: table; width: 101%; left: -3px; right: -3px; position: relative;">
                                        <div style="display: table-row">
