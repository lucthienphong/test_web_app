<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" AutoEventWireup="true" CodeBehind="refPayment.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.refPayment" %>
            ...
            <div class="dataTables_wrapper form-inline sweet-input-mask">
                <div class="dataTables_wrapper form-inline sweet-input-mask">
                    <SweetSoft:GridviewExtension ID="gvReference" runat="server" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            <asp:TemplateField HeaderText="Hexagonal Code" SortExpression="0" HeaderStyle-CssClass="sorting" ItemStyle-Width="100px">
                                <ItemTemplate>
