<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/ModalMasterPage.Master" AutoEventWireup="true" CodeBehind="refProgressCylinderStatus.aspx.cs" Inherits="SweetSoft.APEM.WebApp.Pages.refProgressCylinderStatus" %>
    ...
    <div class="row row_content">
        <div class="col-md-12">
            ...
            <div class="dataTables_wrapper form-inline sweet-input-mask">
                <SweetSoft:GridviewExtension ID="gvProgressCylinderStatus" runat="server" AutoGenerateColumns="false"
                    ...
                    OnPageIndexChanging="gvProgressCylinderStatus_PageIndexChanging"
                    OnSorting="gvProgressCylinderStatus_Sorting"
                    OnRowDeleting="gvProgressCylinderStatus_RowDeleting"
                    OnRowEditing="gvProgressCylinderStatus_RowEditing"
                    OnRowUpdating="gvProgressCylinderStatus_RowUpdating"
                    OnRowCreated="gvProgressCylinderStatus_RowCreated"
                    OnRowCancelingEdit="gvProgressCylinderStatus_RowCancelingEdit">
                    <Columns>
                        <asp:TemplateField HeaderText="Progress Cylinder Status" SortExpression="0" HeaderStyle-CssClass="sorting">
                            <ItemTemplate>
