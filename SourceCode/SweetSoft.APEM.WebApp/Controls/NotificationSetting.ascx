<%@ Control Language="C#" AutoEventWireup="true" Inherits="SweetSoft.APEM.WebApp.Controls.NotificationSetting" Codebehind="NotificationSetting.ascx.cs" %>
            ...
            <div class="col-md-6 col-sm-6" id="mainright">
                <div class="form">
                    ...
                    <div class="form-group" style="margin-bottom:0">
                        <input type="checkbox" class="uniform" id="chkOpenPage" runat="server" value="SweetSoftMessageManager.mainFunction.OpenPage" />
                    ...
                    <div class="col-md-12" style="display: none">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " value="" id="txtNTitleWindow" runat="server"/>
                        </div>
                        <div class="form-group">
                            <label class="control-label">
                                Dismiss action
